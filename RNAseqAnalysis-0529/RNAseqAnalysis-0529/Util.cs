...
namespace RNAseqAnalysis_0529
{
    class Util
    {
        ...
        {
            string resid = @"C:\Code\RNASeqData\gdcpatientdata\Training Data\";
        ...
        public static string GetIdVal(string path)
        {
            string resid = @"C:\Code\RNASeqData\gdcpatientdata\Validation Data\";
            string result = string.Empty;
            result = path.Remove(0, resid.Length);
            string[] resid2 = result.Split(".");
            string fresult = resid2[0];
        ...
        public static double IdSurvival(string UUID, Configurator cfg)
        {
            string[] list = File.ReadAllLines(cfg.survivalpath);
            double q = 0;
        ...
        public static Patient TxttoPatient(string filePath, double survival, string UUID)
        {
