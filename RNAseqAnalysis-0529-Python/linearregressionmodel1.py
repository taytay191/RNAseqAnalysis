...
#print(X_train, Xval)
model = Sequential()
model.add(Dense(1,input_shape = (60488,), activation = 'relu'))
# model.add(Dense(30, activation = 'relu'))
# model.add(Dense(1,))

model.compile(Adam(lr = .0003), 'mean_squared_error')
...
plt.plot(history_dict['val_loss'], label = 'val training loss')
plt.show()

print("Finished")


model.save('C:\Code\RNAseqAnalysis-0529-Python\Model Saves\Linear\weights.h5')